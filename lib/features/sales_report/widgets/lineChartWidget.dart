...
class _LineChartWidgetState extends ConsumerState<LineChartWidget> {
          ...
          child: LineChart(
            LineChartData(
                  ...
                  getTooltipItems: (List<LineBarSpot> touchedSpots) {
                    return touchedSpots.map((LineBarSpot touchedSpot) {
                      ...
                      DateTime startDateTime =
                          dateFormat.parse(widget.paramModel.dateFrom);

                      DateTime startDate = startDateTime;
                      DateTime actualDate = startDate.add(Duration(
                          days: dateValue.toInt() - minXValue.toInt()));

                      String formattedDate =
                          DateFormat('dd-MM-yyyy').format(actualDate);
              ...
              lineBarsData: getLineChartBarData(
                  widget.salesSummaryList, widget.colorList),
              minX: minXValue,
              maxX: maxXValue,
              maxY: maxYValue,
              minY: 0,
  ...
  List<LineChartBarData> getLineChartBarData(
    ...
    for (int i = 0; i < widget.filters.length; i++) {
      ...
      double startingXAxisValue = minXValue;
    ...
    print("line length = ${linesList.length}");
...
//
//   print(allSummaryList[allSummaryList.length - 1]);
//
